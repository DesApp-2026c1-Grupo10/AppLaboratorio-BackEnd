...
function initializeConfig() {
  ...
  let dbConfig = {
    username: 'postgres',
    password: process.env.SQL_PASSWORD || '112233',
...
function getJwtSecret() {
  return process.env.JWT_SECRET || 'labmanager_secret_dev_2024';
}

const config = initializeConfig();
config.getJwtSecret = getJwtSecret;
