...
import * as carritoController from '../controllers/inventario/carrito_controller';
...
router.put(
  '/materiales/:id/mover',
  withErrorHandling(materialController.mover)
);
...
router.put('/reactivos/:id/mover', withErrorHandling(reactivoController.mover));
router.post(
  '/reactivos/:id/producir',
  withErrorHandling(reactivoController.producir)
);
...
router.put('/equipos/:id/mover', withErrorHandling(equipoController.mover));
...
// Carritos
router.get('/carritos', withErrorHandling(carritoController.getAll));
router.get(
  '/carritos/pedido/:pedidoId',
  withErrorHandling(carritoController.getByPedidoId)
);
router.put(
  '/carritos/:id/preparado',
  withErrorHandling(carritoController.marcarPreparado)
);
router.put(
  '/carritos/item/:itemId/preparado',
  withErrorHandling(carritoController.toggleItemPreparado)
);
router.delete('/carritos/:id', withErrorHandling(carritoController.remove));
